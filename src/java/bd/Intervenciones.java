...
public class Intervenciones implements Serializable {
    ...
    public Intervenciones(Date momentointervencion, String intervencion, Puntosdeldia idpuntodeldia, Asistenciareunion idasistenciareunion) {
    ...
    public Intervenciones(Integer idintervenciones, Date momentointervencion, String intervencion, Puntosdeldia idpuntodeldia, Asistenciareunion idasistenciareunion) {
        this.idintervenciones = idintervenciones;
        this.momentointervencion = momentointervencion;
        this.intervencion = intervencion;
        this.idpuntodeldia = idpuntodeldia;
