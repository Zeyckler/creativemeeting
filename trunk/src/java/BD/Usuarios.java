...
public class Usuarios implements Serializable {
    ...
    public Usuarios(String dni, String nombre, String apellido1, Date fechanacimiento, String direccion, String email, String usuario, String contrasena, String localidad, String provincia, String pais, int codigopostal, String cargo, BigDecimal salario, boolean privilegios, boolean activo) {
        this.dni = dni;
        this.nombre = nombre;
